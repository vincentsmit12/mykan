---
title: "Introduction"
description: "Overview and quick start to run BSocial on your own infrastructure using Docker Compose."
mode: "wide"
tag: "NEW"
---

This guide introduces how to self-host BSocial. It starts with the minimal Docker Compose setup (web + PostgreSQL) and points you to optional features like email and S3-based file storage.
...
<CardGroup cols={2}>
  ...
  <Card title="PostgreSQL 15" icon="database" color="#65a30d" horizontal>
    Primary database for BSocial data.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Configure environment (optional)">
    ...
    <Accordion title="Common variables">
      ...
      # Optional: Email
      EMAIL_FROM="BSocial <hello@mail.BSocial>"
